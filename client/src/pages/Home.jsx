    ...
    return (
        <div className='px-2.5 pb-24 '>
            <div className="max-w-[600px] my-20 mx-auto flex flex-col text-center items-center gap-7">
                ...
                <form className='p-2 w-[90%] sm:w-4/5 bg-white border-2 rounded-lg text-xl flex justify-center items-center gap-2.5 ' >
                    <input  type="text" placeholder='Search crypto' className='flex-1 text-base pl-2.5 outline-none border-none  text-gray-600' />
            ...
            <div className='max-w-[800px] m-auto rounded-2xl bg-[linear-gradient(rgba(84,3,255,0.15),rgba(105,2,153,0.15))]'>
                <div className="grid grid-cols-[0.5fr_3fr_1fr_1fr] sm:grid-cols-[0.5fr_2fr_1fr_1fr_1.5fr] py-4 px-5 items-center border-b border-b-[#3c3c3c]">
                    ...
                    <p className='hidden sm:flex text-right '>Market Cap</p>
                </div>
                {displayCoin.map((item, index) => {
                   return <div key={index} className='grid grid-cols-[0.5fr_3fr_1fr_1fr] sm:grid-cols-[0.5fr_2fr_1fr_1fr_1.5fr] py-4 px-5 items-center border-b border-b-[#3c3c3c] last:border-none'>
                        {console.log(item)}
